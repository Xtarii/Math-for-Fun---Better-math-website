...
export default function Chapters() : ReactElement {
    ...
    return (<div className="h-full">
        ...
        {/* Page Content */}
        {chapters?.map((value, index) => <div className="w-full md:w-96 h-14 rounded bg-slate-800 hover:bg-slate-500 border-b-slate-600 border-b-2 md:border-none" key={index}>
